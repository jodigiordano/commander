namespace TDA
{
    ...
    static class FactoryTourelles
    {
        ...
        public static Tourelle creerTourelle(Simulation simulation, TypeTourelle type)
        {
            ...
            switch (type)
            {
                case TypeTourelle.Base:                     t = setBase();                   break;
                case TypeTourelle.Gravitationnelle:         t = setGravitationnelle();       break;
                case TypeTourelle.LaserMultiple:            t = setLaserMultiple();          break;
                case TypeTourelle.LaserSimple:              t = setLaserSimple();            break;
                case TypeTourelle.Missile:                  t = setMissile();                break;
                case TypeTourelle.GravitationnelleAlien:    t = setGravitationnelleAlien();  break;
                case TypeTourelle.SlowMotion:               t = setSlowMotion();             break;
                default:                                    t = setBase();                   break;
            }
