namespace TDA
{
    ...
    class VaisseauDoItYourself : Vaisseau
    {
        ...
        public Vector2 AnciennePositionSouris;
        ...
        private void doModeManuel()
        {
#if XBOX || MANETTE_WINDOWS
            Vector2 donneesThumbstick = Core.Input.Facade.positionThumbstick(Simulation.Main.JoueursConnectes[0].Manette, true, Simulation.Scene.Nom);
...
#else
            Vector2 donneesThumbstick = Core.Input.Facade.positionDeltaSouris(Simulation.Main.JoueursConnectes[0].Manette, Simulation.Scene.Nom);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //Simulation.Scene.ajouterScenable(new LigneVisuel(this.Position, new Vector3(Core.Input.Facade.positionSouris(Simulation.Main.JoueursConnectes[0].Manette, Simulation.Scene.Nom), 0), Color.Red));
        }
    }
}
