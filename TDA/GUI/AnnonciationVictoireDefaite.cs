    ...
    class AnnonciationVictoireDefaite : DrawableGameComponent
    {
        ...
        public void doNouvelEtat(EtatPartie etat)
        {
            ...
            if (Etat != EtatPartie.Gagnee && Etat != EtatPartie.Perdue)
                ...
                //Core.Input.Facade.considererSouris(Simulation.Main.JoueursConnectes[0].Manette, false, Simulation.Scene.Nom);
#else
            Core.Input.Facade.considerTouches(
                    Simulation.Main.JoueursConnectes[0].Manette,
                    new List<Microsoft.Xna.Framework.Input.Buttons>() { Preferences.toucheRetourMenu, Preferences.toucheRetourMenu2 },
                    this.Simulation.Scene.Nom);
