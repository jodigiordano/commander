namespace EphemereGames.Commander
{
    ...
    class SandGlass : IObjetPhysique
    {
        ...
        private EffetRotation RotationEffect;
        ...
        public SandGlass(Main main, Scene scene, double minimumTime, Vector3 position, double visualPriority)
        {
            ...
            Rectangle = new RectanglePhysique(
                (int) (Image.Position.X - representationSize.X),
                (int) (Image.Position.Y - representationSize.Y),
        ...
        public void Flip()
        {
            ...
            RotationEffect = new EffetRotation();
        ...
        {
            Scene.Effects.Add(Image, Core.Visuel.PredefinedEffects.FadeOutTo0(255, 0, time));

            foreach (var pixel in Pixels)
                Scene.Effects.Add(pixel, Core.Visuel.PredefinedEffects.FadeOutTo0(255, 0, time));
        }


        public void FadeIn(double time)
        {
            Scene.Effects.Add(Image, Core.Visuel.PredefinedEffects.FadeInFrom0(255, 0, time));

            foreach (var pixel in Pixels)
                Scene.Effects.Add(pixel, Core.Visuel.PredefinedEffects.FadeInFrom0(255, 0, time));
        }
