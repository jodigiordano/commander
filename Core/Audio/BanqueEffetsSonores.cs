namespace Core.Audio
{
    ...
    class BanqueEffetsSonores
    {
        public Dictionary<String, EffetSonore> EffetsSonores { get; set; }

        public int InstancesActives;

        public BanqueEffetsSonores()
        {
            EffetsSonores = new Dictionary<string, EffetSonore>();
            InstancesActives = 0;
        }
        ...
        public void ajouter(String nomEffetSonore, EffetSonore effetSonore)
        {
