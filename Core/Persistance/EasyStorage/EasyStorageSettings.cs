...
namespace EasyStorage
{
	...
	public static class EasyStorageSettings
	{
		...
		{
#if !WINDOWS_PHONE
			SaveDevice.OkOption = "OK"; //todo
			SaveDevice.YesOption = "Yes";
			SaveDevice.NoOption = "No";
			SaveDevice.DeviceOptionalTitle = "Blabla";
            SaveDevice.DeviceRequiredTitle = "Blabla";
            SaveDevice.ForceDisconnectedReselectionMessage = "Blabla";
            SaveDevice.PromptForDisconnectedMessage = "Blabla";
            SaveDevice.ForceCancelledReselectionMessage = "Blabla";
            SaveDevice.PromptForCancelledMessage = "Blabla";
#endif
		}
	}
}
