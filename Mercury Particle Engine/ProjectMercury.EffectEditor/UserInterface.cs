...
namespace ProjectMercury.EffectEditor
{
    ...
    public partial class UserInterface : Form, IInterfaceProvider
    {
        ...
        private void uxEffectPreview_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            this.uxStatusLabel.Text = this.MousePosition.ToString();
        }
        ...
        {
            x = (float)this.MousePosition.X;
            y = (float)this.MousePosition.Y;
