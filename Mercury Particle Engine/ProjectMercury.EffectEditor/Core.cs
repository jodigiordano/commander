...
namespace ProjectMercury.EffectEditor
{
    ...
    public class Core : ApplicationContext
    {
        ...
        {
            Renderer r = new SpriteBatchRenderer
            {
        ...
        {
            return Texture2D.FromFile(GraphicsDeviceService.Instance.GraphicsDevice, "Textures\\FlowerBurst.png");
        }
        ...
        {
            this.ParticleEffect = InstantiateDefaultParticleEffect();
