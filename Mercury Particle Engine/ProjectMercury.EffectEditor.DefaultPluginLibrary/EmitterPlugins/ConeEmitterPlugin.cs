...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.Emitterplugins
{
    ...
    public class ConeEmitterPlugin : IEmitterPlugin
    {
        /// <summary>
        ...
        {
            get { return "An Emitter which releases particles in a beam which gradually becomes wider."; }
        }
        ...
        {
            ConeEmitter e = (ConeEmitter)existingInstance;
