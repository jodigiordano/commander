...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.Emitterplugins
{
    ...
    public class RectEmitterPlugin : IEmitterPlugin
    {
        /// <summary>
        ...
        {
            get { return "An Emitter which releases particles in a rectangle shape."; }
        }
        ...
        {
            RectEmitter e = (RectEmitter)existingInstance;
