...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class HueShiftModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A Modifier which gradually changes the hue of a Particle over its lifetime."; }
        }
