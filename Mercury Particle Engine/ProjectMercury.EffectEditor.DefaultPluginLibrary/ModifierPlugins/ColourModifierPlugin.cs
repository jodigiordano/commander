...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    public class ColourModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        {
            get { return "A Modifier which gradually changes the colour of a Particle over the course of its lifetime."; }
        }
        ...
        public Modifier CreateDefaultInstance()
        {
            ...
            {
                InitialColour = Colour.Tomato.ToVector3(),
                UltimateColour = Colour.LawnGreen.ToVector3()
            };
        }
    }
}