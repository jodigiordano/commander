...
namespace ProjectMercury.EffectEditor.DefaultPluginLibrary.ModifierPlugins
{
    ...
    /// <summary>
    /// Defines a plugin which provides ColourMergeModifier support to the EffectEditor.
    /// </summary>
    [Export(typeof(IModifierPlugin))]
    public class ColourMergeModifierPlugin : IModifierPlugin
    {
        /// <summary>
        ...
        public string Name
        {
            get { return "Colour Merge Modifier"; }
        }
        ...
        {
            get { return "a Modifier which merges the colour of particles towards a single colour over their lifetime. Works best when Particles are being released with random colours, where you require the particles to have a uniform colour at the end of their lifetime."; }
        }
        ...
        public Modifier CreateDefaultInstance()
        {
            ...
            {
                MergeColour = Colour.Tomato.ToVector3(),
            };
        }
    }
}