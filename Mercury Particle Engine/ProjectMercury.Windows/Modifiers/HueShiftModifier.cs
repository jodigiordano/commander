namespace ProjectMercury.Modifiers
{
    ...
    public sealed class HueShiftModifier : Modifier
    {
        ...
        {
            YIQTransformMatrix = new Matrix(0.299f, 0.587f, 0.114f, 0.000f,
        ...
        public override unsafe void Process(float dt, Particle* particleArray, int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                Vector4.Transform(ref particle->Colour, ref YIQTransformMatrix, out colour);

                // Transform the colour in YIQ space...
                Vector4.Transform(ref colour, ref hueTransform, out colour);

                // Convert the colour back to RGB...
                Vector4.Transform(ref colour, ref RGBTransformMatrix, out colour);
