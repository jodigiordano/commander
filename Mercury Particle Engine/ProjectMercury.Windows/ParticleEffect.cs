...
namespace ProjectMercury
{
    ...
    public class ParticleEffect : EmitterCollection
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating wether the particle effect is in the process of being
        /// updated asynchronously.
        /// </summary>
        private bool Updating;

        /// <summary>
        /// Gets or sets the thread in which the current asynchronous update is occuring.
        /// </summary>
        ...
        {
            this.UpdateThread = new Thread(new ParameterizedThreadStart(this.AsyncUpdate));

            this.UpdateThread.Start(deltaSeconds);
        }

        private void AsyncUpdate(object state)
        {
            float deltaSeconds = (float)state;
