namespace EphemereGames.Commander
{
    ...
    class World
    {
        ...
        public Dictionary<CelestialBody, int> WarpsCelestialBodies;
        ...
        public World(Main main, Scene scene, WorldDescriptor descriptor)
        {
            ...
            WarpsCelestialBodies = new Dictionary<CelestialBody, int>();

            foreach (var celestialBody in Simulation.PlanetarySystemController.CelestialBodies)
            {
                if (LevelsDescriptors.ContainsKey(celestialBody.Nom) && !(celestialBody is PinkHole))
        ...
        public int WorldSelected
        {
            get
            {
                return (Simulation.SelectedCelestialBody != null && Simulation.SelectedCelestialBody is PinkHole) ? Warps[Simulation.SelectedCelestialBody.Nom] : -1;
            }
        }
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (Main.GameInProgress != null)
            {
                ...
                {
                    CelestialBody c = Simulation.PlanetarySystemController.CelestialBodies[i];
