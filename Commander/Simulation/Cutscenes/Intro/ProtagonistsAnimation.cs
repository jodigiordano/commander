namespace EphemereGames.Commander.Cutscenes
{
    ...
    class ProtagonistsAnimation
    {
        ...
        public ProtagonistsAnimation(Simulator simulator)
        {
            ...
            Protagonist = new SpaceshipCursor(simulator.Scene, new Vector3(-200, -600, 0), 5, VisualPriorities.Default.IntroProtagonist, new Color(95, 71, 255), "Cursor1");
            Wife = new SpaceshipCursor(Simulator.Scene, new Vector3(-200, -600, 0), 5, VisualPriorities.Default.IntroWife, new Color(255, 0, 136), "Cursor2");
            Babies = new List<SpaceshipCursor>();

            Babies.Add(new SpaceshipCursor(Simulator.Scene, new Vector3(-200, -600, 0), 5, VisualPriorities.Default.IntroWife, new Color(255, 227, 48), "Cursor3") { Size = 2f });
