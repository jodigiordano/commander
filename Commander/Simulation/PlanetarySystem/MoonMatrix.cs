namespace EphemereGames.Commander.Simulation
{
    ...
    {
        public MoonMatrix(CelestialBody celestialBody, int alpha)
            : this(celestialBody, alpha, "lune" + Main.Random.Next(1, 5), Main.Random.Next(2, 4)) { }


        public MoonMatrix(CelestialBody celestialBody, int alpha, string imageName, int size)
            : base(celestialBody, alpha, imageName, size)
        {
