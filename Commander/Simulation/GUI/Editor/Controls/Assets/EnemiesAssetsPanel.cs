namespace EphemereGames.Commander.Simulation
{
    ...
    class EnemiesAssetsPanel : AssetsPanel
    {
        ...
        {
            return new ImageCheckBox(Simulator.EnemiesFactory.Get((EnemyType) Enum.Parse(typeof(EnemyType), assetName), 1, 1, 1).Image);
        }
    }
}
...
//    class EnemiesAssetsPanel : PanelWidget
//    {
...
//        public EnemiesAssetsPanel(List<Enemy> enemies, int width, int nbColumns)
//        {
//            Enemies = enemies;
