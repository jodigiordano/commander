namespace EphemereGames.Commander.Simulation.Player
{
    ...
    class VisualSpaceship : Cursor
    {
        ...
        public VisualSpaceship(Scene scene, Vector3 initialPosition, float speed, double visualPriority, Color color, string image, bool visible)
