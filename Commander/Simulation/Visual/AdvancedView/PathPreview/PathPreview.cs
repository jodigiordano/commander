namespace EphemereGames.Commander.Simulation
{
    ...
    class PathPreview
    {
        ...
        private Dictionary<SimPlayer, PlayerState> PlayersStates;
        ...
        public PathPreview(Path newPath, Path actualPath)
        {
            ...
            PlayersStates = new Dictionary<SimPlayer, PlayerState>();
        }
        ...
        public void AddCelestialObject(SimPlayer player, CelestialBody obj)
        {
        ...
        public void RemoveCelestialObject(SimPlayer player, CelestialBody obj)
        {
            var state = PlayersStates[player];
        ...
        public void UpgradeCelestialObject(SimPlayer player, CelestialBody obj)
        {
            var state = PlayersStates[player];
        ...
        public void RollBack(SimPlayer player)
        {
            var state = PlayersStates[player];
        ...
        public void Commit(SimPlayer player)
        {
            var state = PlayersStates[player];
        ...
        {
            public SimPlayer Player             { get; private set; }
            public CelestialBody CelestialBody  { get; private set; }
            public PathState PathState          { get; private set; }


            public PlayerState(SimPlayer player)
            {
                Player = player;
                CelestialBody = null;
